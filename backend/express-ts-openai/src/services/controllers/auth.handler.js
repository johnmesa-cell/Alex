...
// Versión reescrita con funciones exportadas directamente.
...
export const register = async (req, res) => {
    try {
        ...
        // Consulta para verificar si el usuario existe por correo.
...
export const login = async (req, res) => {
    try {
        ...
        // Consulta para encontrar al usuario por correo para el login.
